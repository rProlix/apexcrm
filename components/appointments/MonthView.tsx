    ...
    <div className="select-none">
      ...
      <div className="grid grid-cols-7 mb-1">
        {DAY_LABELS.map((d) => (
          <div
            key={d}
            className="py-2 text-center text-xs font-medium text-white/30 uppercase tracking-wider"
          >
            {d}
          </div>
        ))}
              ...
              {cell.day && (
                <>
                  ...
                  <div className="space-y-0.5">
                    ...
                    {hasMore && (
                      <p className="text-2xs text-white/30 pl-1 pt-0.5">+{appts.length - 3} more</p>
                    )}
                  </div>
                </>
              )}
