    ...
    <>
      ...
      >
        ...
        >
          ...
          <span
            style={{ display: 'none', ['@media(min-width:480px)' as never]: { display: 'block' } }}
          >
            {pageName || 'Builder'}
          </span>
        </a>
        ...
        {editMode && (
          <>
            ...
            <IconButton onClick={redo} disabled={future.length === 0} title="Redo (Ctrl+Shift+Z)">
              ↪
            </IconButton>
          </>
        )}
        ...
        {editMode && (
          <>
            <IconButton onClick={() => setVersionOpen(true)} title="Version History">
              🕐
            </IconButton>
            <IconButton
        ...
        <button
          onClick={() => {
            setRestyleDrawer(!showRestyleDrawer)
            if (showPremiumDrawer) setPremiumDrawer(false)
          }}
        ...
        <button
          onClick={() => {
            setPremiumDrawer(!showPremiumDrawer)
            if (showRestyleDrawer) setRestyleDrawer(false)
          }}
      ...
      <VersionHistoryPanel open={versionOpen} onClose={() => setVersionOpen(false)} />
    </>
  )
}
