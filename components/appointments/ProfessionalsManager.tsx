        ...
        {loading ? (
          ...
          <div className="px-5 py-12 text-center">
            ...
            <p className="text-xs text-white/20 mt-1">
              Add staff members to assign availability blocks and appointments
            </p>
          </div>
        ) : (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {p.is_active ? (
                        <span className="text-2xs px-1.5 py-0.5 rounded-full border border-emerald-500/30 text-emerald-400 bg-emerald-400/8 font-medium">
                          Active
                        </span>
                      ) : (
                        <span className="text-2xs px-1.5 py-0.5 rounded-full border border-surface-border text-white/25 font-medium">
                          Inactive
                        </span>
                      )}
                    </div>
                  ...
                  >
                    {form.is_active ? (
                      <>
                        ...
                        <span className="text-gold-400 text-xs font-medium">Active</span>
                      </>
                    ) : (
                      <>
