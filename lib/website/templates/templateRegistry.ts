...
export const WEBSITE_TEMPLATES: WebsiteTemplate[] = [
  // ── 1. Luxe One-Page Parallax ─────────────────────────────────────────────
  {
    ...
    description:
      'Premium one-page design with smooth scroll storytelling, layered backgrounds, curved section transitions, floating testimonial cards, and parallax movement.',
    category: 'luxury',
    layoutType: 'parallax',
    ...
    sectionBlueprints: [
      {
        ...
        design: sd({
          ...
          backgroundValue: 'linear-gradient(180deg, #0d0d14 0%, #1a1a2e 100%)',
          textColor: '#f5f0e8',
          subtextColor: 'rgba(245,240,232,0.78)',
          spacing: 'luxury',
          dividerBottom: 'curve',
          overlay: {
            enabled: true,
            type: 'gradient',
            value: 'linear-gradient(to bottom, rgba(13,13,20,0.4) 0%, rgba(13,13,20,0.8) 100%)',
            opacity: 0.6,
          },
        }) as never,
        layoutVariant: 'fullscreen_center',
      ...
      },
      {
        ...
        order: 2,
        design: sd({
          backgroundType: 'layered',
          backgroundValue: '#1e1e2a',
          textColor: '#f5f0e8',
          subtextColor: '#c4bfb0',
          spacing: 'airy',
          cardStyle: 'glass',
      ...
      },
      {
        ...
        design: sd({
          backgroundType: 'gradient',
          backgroundValue: 'linear-gradient(135deg, #0d0d14 0%, #1a1a2e 100%)',
          textColor: '#f5f0e8',
          subtextColor: '#c4bfb0',
          spacing: 'luxury',
          cardStyle: 'glass',
      ...
      },
      {
        ...
        design: sd({
          backgroundType: 'gradient',
          backgroundValue: 'linear-gradient(135deg, #c9a84c 0%, #e8c96b 100%)',
          textColor: '#0d0d14',
          subtextColor: '#2a1f00',
          spacing: 'luxury',
          dividerTop: 'angle',
        }) as never,
        layoutVariant: 'fullwidth_dark',
      },
      {
        slot: 'contact',
        sectionType: 'contact',
  ...
  // ── 2. Apple-Style Product Story ─────────────────────────────────────────
  {
    ...
    description:
      'A scroll-driven product showcase where the featured item moves and transforms as you scroll. Premium product storytelling for launches, retail, and restaurants featuring signature items.',
    ...
    sectionBlueprints: [
      {
        ...
        layoutVariant: 'product_story_intro',
        visualIntent: 'Dark cinematic product introduction',
      },
      {
        slot: 'feature_grid',
        sectionType: 'feature_grid',
  ...
  // ── 3. Premium Restaurant Glow ────────────────────────────────────────────
  {
    ...
    description:
      'Warm, appetizing restaurant site with cinematic food photography overlays, menu showcase, curved section transitions, reservation CTAs, and review cards.',
    category: 'restaurant',
    layoutType: 'standard',
    ...
    features: [
      'Cinematic hero with food imagery',
      'Menu grid section',
      'Warm color palette',
      'Review carousel',
      'Reservation CTA',
    ...
    sectionBlueprints: [
      {
        ...
        design: sd({
          ...
          overlay: {
            enabled: true,
            type: 'gradient',
            value: 'linear-gradient(to bottom, rgba(44,24,16,0.3) 0%, rgba(44,24,16,0.75) 100%)',
            opacity: 0.75,
          },
      ...
      },
      {
        ...
        design: sd({
          backgroundType: 'gradient',
          backgroundValue: 'linear-gradient(135deg, #2c1810 0%, #4a2520 100%)',
          textColor: '#fdf6ee',
          subtextColor: 'rgba(253,246,238,0.8)',
          spacing: 'luxury',
          cardStyle: 'glass',
          dividerTop: 'curve',
          dividerBottom: 'curve',
      ...
      },
      {
        ...
        design: sd({
          backgroundType: 'gradient',
          backgroundValue: 'linear-gradient(135deg, #c9571a 0%, #e8a830 100%)',
          textColor: '#ffffff',
  ...
  // ── 4. Modern Local Service ───────────────────────────────────────────────
  {
    ...
    description:
      'Trust-focused service business template with bold hero CTA, service cards, social proof, FAQ, and booking/contact integration.',
    ...
    sectionBlueprints: [
      {
        ...
        design: sd({
          ...
          textColor: '#f8fafc',
          subtextColor: 'rgba(248,250,252,0.82)',
          spacing: 'luxury',
          dividerBottom: 'angle',
        }) as never,
        layoutVariant: 'trust_hero',
      },
      {
        slot: 'feature_grid',
        sectionType: 'feature_grid',
      ...
      },
      {
        ...
        design: sd({
          backgroundType: 'gradient',
          backgroundValue: 'linear-gradient(135deg, #1e5fa8 0%, #1e3a5f 100%)',
          textColor: '#ffffff',
          subtextColor: 'rgba(255,255,255,0.88)',
          spacing: 'luxury',
        }) as never,
  ...
  // ── 5. Luxury Editorial Brand ─────────────────────────────────────────────
  {
    ...
    description:
      'Ultra-high-end editorial aesthetic with oversized typography, full-bleed imagery, slow elegant transitions, and a signature quiet-luxury feel.',
    category: 'luxury',
    ...
    sectionBlueprints: [
      {
        ...
        design: sd({
          backgroundType: 'image',
          textColor: '#f0ebe4',
          subtextColor: 'rgba(240,235,228,0.85)',
          spacing: 'luxury',
          dividerBottom: 'fade',
          overlay: {
            enabled: true,
            type: 'gradient',
            value: 'linear-gradient(to bottom, rgba(26,21,18,0.2) 0%, rgba(26,21,18,0.7) 100%)',
            opacity: 0.7,
          },
        }) as never,
        layoutVariant: 'editorial_full',
      },
      {
        slot: 'about',
        sectionType: 'about',
  ...
  // ── 6. Promo Launch Page ──────────────────────────────────────────────────
  {
    ...
    description:
      'High-energy temporary promotion template for sales, events, holiday offers, and limited-time products. Applies a promo overlay to existing content without deleting it.',
    category: 'promo',
    layoutType: 'promo',
    animationLevel: 'balanced',
    icon: '🎯',
    ...
    sectionBlueprints: [
      {
        ...
        design: sd({
          backgroundType: 'gradient',
          backgroundValue: 'linear-gradient(135deg, #7c3aed 0%, #db2777 60%, #f59e0b 100%)',
          textColor: '#ffffff',
          subtextColor: 'rgba(255,255,255,0.9)',
          spacing: 'luxury',
          dividerBottom: 'wave',
        }) as never,
        layoutVariant: 'promo_center',
      },
      {
        slot: 'feature_grid',
        sectionType: 'feature_grid',
      ...
      },
      {
        ...
        design: sd({
          backgroundType: 'gradient',
          backgroundValue: 'linear-gradient(135deg, #f59e0b 0%, #db2777 100%)',
          textColor: '#ffffff',
          spacing: 'luxury',
          dividerTop: 'wave',
        }) as never,
        layoutVariant: 'promo_cta',
      },
      {
        slot: 'testimonials',
        sectionType: 'testimonials',
  ...
  // ── 7. Boutique Retail Showcase ───────────────────────────────────────────
  {
    ...
    description:
      'Curated boutique aesthetic with product-forward layout, editorial photography treatment, and sophisticated brand presence.',
    category: 'retail',
    layoutType: 'standard',
    animationLevel: 'balanced',
    icon: '🏪',
    ...
    sectionBlueprints: [
      ...
      },
      {
        ...
        design: sd({
          backgroundType: 'solid',
          backgroundValue: '#faf7f4',
          textColor: '#2c1f16',
          spacing: 'airy',
          cardStyle: 'floating',
          imageTreatment: 'editorial',
        }) as never,
        layoutVariant: 'product_editorial',
      },
      {
        slot: 'about',
        sectionType: 'about',
  ...
  // ── 8. Clean SaaS Landing ─────────────────────────────────────────────────
  {
    ...
    description:
      'Crisp, conversion-focused SaaS landing page with feature grids, trust signals, testimonials, and a clear pricing/CTA path.',
    category: 'saas',
    layoutType: 'standard',
    animationLevel: 'subtle',
    icon: '⚡',
    ...
    features: [
      'Gradient hero with product preview',
    ...
    sectionBlueprints: [
      {
        ...
        design: sd({
          backgroundType: 'gradient',
          backgroundValue: 'linear-gradient(135deg, #0f172a 0%, #1e3a5f 60%, #2563eb 100%)',
          textColor: '#ffffff',
          subtextColor: 'rgba(255,255,255,0.82)',
          spacing: 'luxury',
          dividerBottom: 'angle',
        }) as never,
        layoutVariant: 'saas_hero',
      },
      {
        slot: 'feature_grid',
        sectionType: 'feature_grid',
      ...
      },
      {
        ...
        design: sd({
          backgroundType: 'gradient',
          backgroundValue: 'linear-gradient(135deg, #2563eb 0%, #1e3a5f 100%)',
          textColor: '#ffffff',
          spacing: 'luxury',
        }) as never,
      },
  ...
  // ── 9. Trustworthy Law Firm ───────────────────────────────────────────────
  {
    ...
    description:
      'Authoritative, dignified professional law firm website. Classic serif typography, deep navy palette, editorial layout, and no gimmicks.',
    category: 'law',
    layoutType: 'standard',
    animationLevel: 'none',
    icon: '⚖',
    ...
    sectionBlueprints: [
      {
        ...
        design: sd({
          backgroundType: 'gradient',
          backgroundValue: 'linear-gradient(180deg, #0a1628 0%, #1a2d4a 100%)',
          textColor: '#f8f7f5',
          subtextColor: 'rgba(248,247,245,0.8)',
          spacing: 'luxury',
          dividerBottom: 'angle',
        }) as never,
        layoutVariant: 'law_authority',
      },
      {
        slot: 'feature_grid',
        sectionType: 'feature_grid',
        ...
        design: sd({
          backgroundType: 'solid',
          backgroundValue: '#f8f7f5',
          textColor: '#0a1628',
          spacing: 'airy',
          cardStyle: 'bordered',
        }) as never,
        layoutVariant: 'practice_areas',
      },
      {
        slot: 'about',
        sectionType: 'about',
      ...
      },
      {
        ...
        design: sd({
          backgroundType: 'gradient',
          backgroundValue: 'linear-gradient(135deg, #1a2d4a 0%, #0a1628 100%)',
          textColor: '#f8f7f5',
          subtextColor: 'rgba(248,247,245,0.8)',
          spacing: 'luxury',
        }) as never,
  ...
  // ── 10. Automotive Showroom ───────────────────────────────────────────────
  {
    ...
    description:
      'Powerful, precision-engineered automotive website. Dark surfaces, metallic accents, angular dividers, and cinematic vehicle imagery treatment.',
    category: 'automotive',
    layoutType: 'standard',
    animationLevel: 'cinematic',
    icon: '🚗',
    ...
    sectionBlueprints: [
      {
        ...
        design: sd({
          backgroundType: 'image',
          textColor: '#e8e8e8',
          subtextColor: 'rgba(232,232,232,0.82)',
          spacing: 'luxury',
          dividerBottom: 'angle',
          overlay: {
            enabled: true,
            type: 'gradient',
            value: 'linear-gradient(to bottom, rgba(0,0,0,0.2) 0%, rgba(0,0,0,0.75) 100%)',
            opacity: 0.75,
          },
        }) as never,
        layoutVariant: 'automotive_hero',
      },
      {
        slot: 'feature_grid',
        sectionType: 'feature_grid',
        ...
        layoutVariant: 'vehicle_showcase',
      },
      {
        slot: 'about',
        sectionType: 'about',
      ...
      },
      {
        ...
        design: sd({
          backgroundType: 'gradient',
          backgroundValue: 'linear-gradient(135deg, #1e1e1e 0%, #d4af37 200%)',
          textColor: '#e8e8e8',
          spacing: 'luxury',
          dividerTop: 'angle',
        }) as never,
