    ...
    return NextResponse.json(
      {
        ...
        error: {
          type: 'forbidden',
          title: 'Forbidden',
          message: 'Only owners and admins can upload reference images.',
        },
      },
      { status: 403 }
    )
    ...
    return NextResponse.json(
      {
        ...
        error: {
          type: 'invalid_request',
          title: 'Missing image',
          message: 'No image file provided. Include it as field "image".',
        },
      },
      { status: 400 }
    )
    ...
    return NextResponse.json(
      {
        ...
        error: {
          ...
          message: `Image must be JPEG, PNG, or WebP. Got: ${contentType}`,
        },
      },
      { status: 400 }
    )
    ...
    return NextResponse.json(
      {
        ...
        error: {
          ...
          message: `Reference image must be under 10 MB. Got: ${Math.round(imageFile.size / 1024)} KB`,
        },
      },
      { status: 400 }
    )
    ...
    return NextResponse.json(
      {
        ...
        error: {
          type: 'invalid_request',
          title: 'No product',
          message: 'Package has no product assigned. Assign a product first.',
        },
      },
      { status: 422 }
    )
