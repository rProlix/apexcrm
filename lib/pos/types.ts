...
export type POSFulfillmentStatus = 'not_started' | 'preparing' | 'ready' | 'fulfilled' | 'cancelled'
...
export type POSChannel = 'pos' | 'online' | 'phone' | 'kiosk' | 'delivery' | 'pickup'
...
export type POSModifierType = 'addon' | 'removal' | 'substitution' | 'instruction' | 'preparation'

export type POSItemType = 'product' | 'service' | 'custom' | 'fee' | 'discount'

export type POSKitchenStatus =
  | 'new'
  | 'accepted'
  | 'preparing'
  | 'ready'
...
export type POSDeductionTiming =
  | 'order_created'
  | 'sent_to_kitchen'
  | 'payment_completed'
  | 'order_completed'
