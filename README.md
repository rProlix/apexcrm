...
The Slack, queue, private-media, and AI-analysis foundation and standalone worker source are documented in [`docs/van-damage-ai-phase2.md`](docs/van-damage-ai-phase2.md). Phase 2 does not deploy anything to EC2.
...
# Reference-guided provider compatibility
