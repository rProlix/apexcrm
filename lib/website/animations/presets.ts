...
export const STYLE_PRESET_CLASSES: Record<StylePreset, string> = {
  ...
  cinematic_cta:
    'relative bg-gradient-to-r from-violet-900 to-indigo-900 text-white py-20 overflow-hidden',
  boutique_gallery: 'bg-stone-100 dark:bg-zinc-900 py-12',
  service_showcase: 'bg-white dark:bg-zinc-950 py-16',
  high_trust_reviews:
    'bg-gradient-to-b from-white to-slate-50 dark:from-zinc-950 dark:to-zinc-900 py-20',
...
export const IMAGE_TREATMENT_CLASSES: Record<string, string> = {
  ...
  soft_gradient_overlay:
    'after:absolute after:inset-0 after:bg-gradient-to-t after:from-black/60 after:to-transparent',
...
export const BUTTON_TREATMENT_CLASSES: Record<string, string> = {
  ...
  outline_luxury:
    'bg-transparent border-2 border-current hover:bg-current hover:text-white transition-colors',
}
