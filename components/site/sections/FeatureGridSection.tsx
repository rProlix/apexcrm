        ...
        {(headline || subtitle) && (
          <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
            {headline && (
              <AnimatedElement
                ...
                style={{
                  ...
                  fontWeight:
                    'var(--font-weight-heading, 700)' as React.CSSProperties['fontWeight'],
            ...
            {subtitle && (
              <AnimatedElement
                as="p"
                animConfig={ca?.subheading ?? ca?.text}
                index={1}
                style={{
                  fontSize: '1.125rem',
        ...
        <div style={{ display: 'grid', gridTemplateColumns: gridCols, gap: '1.75rem' }}>
          {items.map((item, i) => {
            ...
            return (
              <AnimatedElement
                key={i}
                animConfig={ca?.card ?? ca?.feature_card}
                index={i}
                style={{
                ...
                {image && (
                  <Image
                    ...
                    style={{
                      ...
                      height: 160,
                      objectFit: 'cover',
                      borderRadius: 'var(--radius-image, 0.5rem)',
                    }}
                  />
                )}
                {icon && !image && (
