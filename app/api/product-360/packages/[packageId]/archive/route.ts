...
export async function POST(req: NextRequest, ctx: Ctx) {
    ...
    return NextResponse.json(
      {
        ...
        error: {
          type: 'forbidden',
          title: 'Forbidden',
          message: 'Only owners and admins can archive packages.',
        },
      },
      { status: 403 }
    )
    ...
    return NextResponse.json(
      {
        ...
        error: {
          ...
          message:
            'This package is currently generating. Stop generation first, or pass forceArchive: true to archive anyway.',
        },
      },
      { status: 409 }
    )
  ...
  return NextResponse.json({
    ...
    data: {
      packageId,
      status: 'archived',
      message: 'Package archived successfully. No images were deleted.',
    },
  })
}
