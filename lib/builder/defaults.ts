...
export const SECTION_TYPES: SectionTypeDef[] = [
  ...
  },
  {
    ...
    description: 'Interactive drag-to-rotate 360° product spin — powered by AI or manual upload',
    icon: '🔄',
    defaultContent: {
      productId: '',
      packageId: '',
...
export const SECTION_TYPE_MAP = new Map(SECTION_TYPES.map((t) => [t.type, t]))
