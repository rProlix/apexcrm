...
export function isAnimationPreset(value: unknown): value is NexoraAnimationPreset {
  return (
    typeof value === 'string' && (NEXORA_ANIMATION_PRESETS as readonly string[]).includes(value)
  )
}
...
const ROLE_PRESET: Record<
  SectionRole,
  {
    subtle: NexoraAnimationPreset
    balanced: NexoraAnimationPreset
    premium_cinematic: NexoraAnimationPreset
  }
> = {
