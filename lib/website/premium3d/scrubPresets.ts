...
export const SCRUB_PRESETS: ScrubPreset[] = [
  ...
  {
    key: 'restaurant_dish',
    label: 'Restaurant Dish Assembly',
    mode: 'video',
  ...
  {
    key: 'salon_before_after',
    label: 'Salon Before/After',
    mode: 'image_sequence',
  ...
  {
    key: 'luxury_service_story',
    label: 'Luxury Service Story',
    mode: 'video',
