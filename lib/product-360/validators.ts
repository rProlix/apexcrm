...
export function validateLightingPreset(
  value: string | null | undefined
): P360ValidationError | null {
  if (!value) return null
...
export function validateBackgroundPreset(
  value: string | null | undefined
): P360ValidationError | null {
  if (!value) return null
...
export function validateCategoryPreset(
  value: string | null | undefined
): P360ValidationError | null {
  if (!value) return null
...
export function validateTurnDirection(
  value: string | null | undefined
): P360ValidationError | null {
  if (!value) return null
...
export function mapDbErrorToApiError(message: string): P360ApiError {
  ...
  if (m.includes('p360_pkg_camera_preset_check')) {
    return {
      ...
      title: 'Invalid camera preset',
      message:
        'The selected camera preset is not recognised by the database. Please choose a valid option.',
      details: message,
    }
  }
