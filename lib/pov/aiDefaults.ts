...
export function generatePovDefaults(
  eventType: PovEventType | string | null | undefined
): PovDefaults {
  ...
  return {
    ...
    upload_instructions:
      'Snap a photo, record a 15-second clip, or leave a 30-second audio message. Everything you add reveals to the whole gallery tomorrow.',
