    ...
    <div className="min-h-dvh bg-graphite-950 text-white">
      <header className="sticky top-0 z-[20] border-b border-white/[0.07] bg-graphite-950/92 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
          <Link href="/" className="flex min-w-0 items-center gap-3 rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-400">
            ...
            <span className="min-w-0">
              <span className="block truncate text-sm font-semibold tracking-[-0.01em]">NexoraNow</span>
