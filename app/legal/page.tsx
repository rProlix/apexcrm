...
export const metadata: Metadata = {
  ...
  description: 'NexoraNow terms, privacy disclosures, acceptable use rules, AI transparency, and data processing terms.',
}
    ...
    <div className="pb-12">
      <div className="max-w-3xl">
        ...
        <p className="mt-5 max-w-2xl text-base leading-7 text-white/55">
          Review how NexoraNow handles data, AI-assisted workflows, platform use, and business processing responsibilities.
        </p>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-5">
                ...
                <ArrowUpRight className="h-4 w-4 text-white/25 transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-gold-400" aria-hidden="true" />
              </div>
              <div className="mt-7">
      ...
      <section className="mt-12 rounded-2xl border border-white/[0.08] bg-graphite-900/65 p-6 sm:p-8">
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-white/50">
          Contact the appropriate team and include the workspace name connected to your request when relevant.
        </p>
