...
} from '@/lib/appointments/availabilityBlocks'
...
export async function PATCH(req: NextRequest, { params }: Ctx) {
  ...
  const result = await updateAvailabilityBlock(id, {
    ...
    slot_duration_minutes:
      body.slotDurationMinutes !== undefined ? Number(body.slotDurationMinutes) : undefined,
    buffer_before_minutes:
      body.bufferBeforeMinutes !== undefined ? Number(body.bufferBeforeMinutes) : undefined,
    buffer_after_minutes:
      body.bufferAfterMinutes !== undefined ? Number(body.bufferAfterMinutes) : undefined,
    max_bookings_per_slot:
      body.maxBookingsPerSlot !== undefined ? Number(body.maxBookingsPerSlot) : undefined,
    is_active: body.isActive !== undefined ? Boolean(body.isActive) : undefined,
    recurrence_rule:
      body.recurrenceRule !== undefined ? (body.recurrenceRule as string) || null : undefined,
  })
