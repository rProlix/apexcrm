        ...
        {selectedTemplate && (
          ...
          >
            ...
            <div style={{ marginBottom: '1rem' }}>
              ...
              <p style={{ fontSize: '0.8125rem', color: '#a8a4a0' }}>
            ...
            <div style={{ marginBottom: '1.25rem' }}>
              ...
              >
                {ANIMATION_LABELS[selectedTemplate.animationLevel] ??
                  selectedTemplate.animationLevel}
              </span>
            </div>
            ...
            {previewing && (
              ...
              >
                <p style={{ margin: 0, color: '#7a7570', fontSize: '0.875rem' }}>
            ...
            {previewMappings && !previewing && (
              <div style={{ marginBottom: '1.25rem' }}>
                ...
                >
                  Content Mapping ({previewMappings.filter((m) => m.hasContent).length}/
                  {previewMappings.length} sections matched)
                </p>
                {previewMappings.map((m) => (
                  ...
                  >
                    <span style={{ color: '#c4bfb0', textTransform: 'capitalize' }}>
                      {m.slot.replace(/_/g, ' ')}
                    </span>
            ...
            >
              ...
              {[
                {
                  label: 'Preserve current brand colors',
                  value: preserveBrand,
                  set: setPreserveBrand,
                },
                { label: 'Preserve current images', value: preserveImages, set: setPreserveImages },
                {
                  label: 'Generate missing images with AI',
                  value: generateMissingImages,
                  set: setGenerateMissingImages,
                },
                {
                  label: 'Apply premium animations',
                  value: applyAnimations,
                  set: setApplyAnimations,
                },
                {
                  label: 'Create version checkpoint',
                  value: createCheckpoint,
                  set: setCreateCheckpoint,
                },
              ].map(({ label, value, set }) => (
                <label
                  key={label}
        ...
        >
          <h3
            style={{
              fontSize: '0.9375rem',
              fontWeight: 600,
              color: isSelected ? '#c9a84c' : '#e8e6e0',
              margin: 0,
            }}
          >
            {template.name}
