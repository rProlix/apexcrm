...
test('historical and detailed canonical regions map to compatible Transit panels and views', () => {
  ...
  assert.equal(normalizeTransitRegion('tailgate'), null)
  assert.equal(normalizeTransitRegion('rear door'), null)
  assert.equal(normalizeTransitRegion('door'), null)
  assert.equal(normalizeTransitRegion('wheel'), null)
