...
export type P360PackageType = 'ai_generated' | 'uploaded_frames' | 'hybrid' | 'model_3d'

export type P360JobStatus = 'queued' | 'running' | 'completed' | 'failed' | 'cancelled'

export type P360HotspotAction = 'info' | 'link' | 'add_to_cart' | 'open_section' | 'promo'
