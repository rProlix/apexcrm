...
const sectionCls = 'rounded-2xl border border-surface-border bg-graphite-800/50 p-6 space-y-4'
    ...
    <div className="space-y-6">
      <div className={sectionCls}>
        <SectionHead
          ...
          subtitle="Your business name and primary contact details"
        />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-2 bg-graphite-700/50 border border-surface-border rounded-xl px-3.5 py-2.5">
              <span
                className={cn(
                  ...
                  tenantStatus === 'active' ? 'bg-emerald-400' : 'bg-white/30'
                )}
              />
          ...
          <div className="col-span-1 sm:col-span-2">
            ...
            <input
              ...
              placeholder="Quality service, every time."
            />
          </div>
        </div>
      </div>
      ...
      <div className={sectionCls}>
        <SectionHead
          ...
          subtitle="Shown on your public website and customer communications"
        />
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
...
function DomainTab({
  ...
  const activePublicUrl =
    domainType === 'custom' && verifiedDomains[0] ? `https://${verifiedDomains[0]}` : subdomainUrl
    ...
    <div className="space-y-6">
      ...
      <div className={sectionCls}>
        ...
        <p className="text-xs text-white/40">
          Your site is always reachable at this address, even without a custom domain.
        </p>
      ...
      <div className={sectionCls}>
        <SectionHead
          ...
          color="text-gold-400"
          title="Active Domain"
          subtitle="Choose which domain powers your public website"
        />
                ...
                <div className="flex items-center gap-2 mb-1">
                  <div
                    className={cn(
                      ...
                      domainType === type ? 'border-gold-400 bg-gold-400' : 'border-white/20'
                    )}
                  />
      ...
      <div className={sectionCls}>
        <SectionHead
          ...
          subtitle="Register and manage custom domains for your site"
        />
              ...
              >
                ...
                {d.verified ? (
                  ...
                  <span className="text-xs text-amber-400/80 flex items-center gap-1">
                    <Info className="h-3 w-3" /> Pending DNS
                  </span>
                )}
                <button
        ...
        <div className="rounded-xl bg-blue-500/8 border border-blue-500/20 p-4 space-y-3">
          ...
          <p className="text-xs text-white/50">
            Add the following DNS record at your domain registrar to point your domain to this
            platform:
          </p>
          <div className="rounded-lg bg-graphite-900/60 border border-white/8 p-3 font-mono text-xs space-y-1.5">
            {[
              ['Type', 'CNAME', 'text-amber-300'],
              ['Name', '@ or www', 'text-white'],
              ['Value', 'cname.vercel-dns.com', 'text-emerald-300'],
              ['TTL', '3600', 'text-white'],
            ].map(([key, val, cls]) => (
          ...
          <p className="text-xs text-white/30">
            DNS propagation can take up to 48 hours after saving.
          </p>
        </div>
      </div>
    </div>
...
function AppearanceTab({
  ...
  const [accentColor, setAccentColor] = useState(
    String((branding as Record<string, string>).accent_color ?? '#a07830')
  )
  ...
  const {
    ...
    save: bSave,
    clearError: bClear,
  } = useSave('/api/settings/tenant', buildBrandingBody)
  ...
  const {
    ...
    save: sSave,
    clearError: sClear,
  } = useSave('/api/website/settings', buildSiteBody)
    ...
    <div className="space-y-6">
      <div className={sectionCls}>
        <SectionHead
          ...
          subtitle="Logo, favicon, and site name"
        />
        ...
        <div>
          ...
          <p className="text-xs text-white/30 mt-1">
            Shown in the browser tab and throughout your site.
          </p>
        </div>
        <div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="mt-1 text-xs leading-5 text-white/40">
                  Used in your CRM navigation and branded workspace loading animation. PNG, JPEG, or
                  WebP up to 5 MB.
                </p>
              </div>
              <label
                className={cn(
                  'ui-button-secondary w-fit cursor-pointer',
      ...
      <div className={sectionCls}>
        <SectionHead
          ...
          color="text-violet-400"
          title="Brand Colors"
          subtitle="Primary and accent colors used across your site"
        />
        ...
        <div className="rounded-xl border border-surface-border overflow-hidden">
          ...
          >
            <div className="flex h-7 w-7 items-center justify-center overflow-hidden rounded-md border border-white/10 bg-white/90 p-1">
              {logoUrl ? (
                ...
                <span className="text-[9px] font-bold text-graphite-900">
                  {getBrandInitials(tenantName)}
                </span>
              )}
            </div>
          ...
          <div className="px-4 py-3 bg-graphite-900/80">
            <p className="text-xs text-white/50">
              Background content with <span style={{ color: primaryColor }}>primary link</span> and{' '}
    ...
    <div className="space-y-6">
      <div className={sectionCls}>
        <SectionHead
          ...
          subtitle="Default values — individual pages can override these"
        />
        ...
        <div>
          ...
          />
          <p className="text-xs text-white/30 mt-1">
            Use {'{{page}}'} as a placeholder for the current page name.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          />
          <p className="text-xs text-white/30 mt-1">
            Leave blank to use the active domain automatically.
          </p>
        </div>
      </div>
      ...
      <div className={sectionCls}>
        <SectionHead
          ...
          subtitle="Approximate how your homepage looks in Google"
        />
        <div className="rounded-xl bg-white p-4 space-y-1">
          <p className="text-xs text-[#1a0dab] font-medium truncate">
            {title || 'Page Title Goes Here'}
          </p>
          <p className="text-xs text-[#006621] font-mono">
            https://{tenantId.slice(0, 6)}... › home
          </p>
          <p className="text-xs text-[#545454] leading-relaxed line-clamp-2">
            {desc ||
              'Your meta description will appear here. Write a compelling summary to increase click-through rates from search results.'}
          </p>
        </div>
      </div>
          ...
          {members
            ...
            .map((m) => (
              ...
              >
                ...
                {m.status === 'invited' && (
                  <span className="text-xs text-amber-400 bg-amber-500/15 border border-amber-500/25 rounded-full px-2 py-0.5">
                    Invited
                  </span>
                )}
      ...
      {canManage && (
        <div className={sectionCls}>
          <SectionHead
            ...
            subtitle="New members receive an email with login instructions"
          />
    ...
    <div className="space-y-6">
      <div className={sectionCls}>
        <SectionHead
          ...
          color="text-gold-400"
          title="Current Plan"
          subtitle="Your subscription and billing information"
        />
          ...
          <>
            ...
            <dl className="space-y-3">
              ...
              {subscription.stripe_customer_id && (
                <div className="flex items-center justify-between py-2 border-b border-white/5">
                  <dt className="text-xs text-white/35 uppercase tracking-wider">
                    Stripe Customer
                  </dt>
                  <dd className="text-sm text-white/50 font-mono">
                    {subscription.stripe_customer_id}
                  </dd>
                </div>
              )}
      ...
      <div className={sectionCls}>
        <SectionHead
          ...
          subtitle="Compare and upgrade your plan"
        />
              ...
              <div
                ...
                className={cn(
                  ...
                  isCurrent
                    ...
                    : 'border-surface-border bg-graphite-700/30'
                )}
              >
          ...
          {visibleModules.map((mod) => {
            ...
            return (
              ...
              >
                ...
                >
                  <Icon
                    className={cn('h-4 w-4', enabled ? 'text-gold-400' : 'text-white/30')}
                    strokeWidth={1.75}
                  />
                </div>
                <div className="flex-1 min-w-0">
...
function NotificationsTab() {
  ...
  const { saving, saved, error, save, clearError } = useSave(
    ...
    <div className="space-y-6">
      <div className={sectionCls}>
        <SectionHead
          ...
          subtitle="Receive email alerts for important events in your CRM"
        />
        <div className="space-y-1 divide-y divide-white/5">
          ...
          <Toggle
            ...
            description="Alert when a new lead enters your pipeline"
          />
          <Toggle
            value={emailNewCustomer}
            onChange={setEmailNewCustomer}
            label="New customer signup"
            description="Alert when a customer creates an account"
          />
          <Toggle
            value={emailAppointment}
            onChange={setEmailAppointment}
            label="Appointment reminder"
            description="24-hour reminder for upcoming appointments"
          />
          <Toggle
            value={emailPayment}
            onChange={setEmailPayment}
            label="Payment received"
            description="Alert when a payment is processed successfully"
          />
          <Toggle
            value={emailWeekly}
            onChange={setEmailWeekly}
            label="Weekly digest report"
            description="Summary of your CRM activity every Monday"
          />
        </div>
      </div>
      ...
      <div className={sectionCls}>
        <SectionHead
          ...
          color="text-violet-400"
          title="Webhooks"
          subtitle="Send event data to your own server or third-party tools"
        />
        <div>
          ...
          <input
            className={inputCls}
            type="url"
            placeholder="https://hooks.yourserver.com/crm"
            value={webhookUrl}
            onChange={(e) => setWebhookUrl(e.target.value)}
          />
          <p className="text-xs text-white/30 mt-1">
            We'll send a POST request with event data as JSON.
          </p>
        </div>
        <div className="space-y-1 divide-y divide-white/5">
          <Toggle
            value={webhookNewOrder}
            onChange={setWebhookNewOrder}
            label="Trigger on new order"
            description="POST to endpoint when an order is created"
          />
          <Toggle
            value={webhookNewLead}
            onChange={setWebhookNewLead}
            label="Trigger on new lead"
            description="POST to endpoint when a lead is captured"
          />
        </div>
    ...
    <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            {newPwd && (
              <div className="mt-2 space-y-1">
                ...
                <p className={cn('text-xs', strengthColors[strength].replace('bg-', 'text-'))}>
          ...
          <div>
            ...
            <input
              className={cn(
                inputCls,
                confirmPwd && newPwd !== confirmPwd && 'border-red-500/50 focus:border-red-500/70'
              )}
              type="password"
              placeholder="••••••••"
              value={confirmPwd}
      ...
      <div className={sectionCls}>
        <SectionHead
          ...
          subtitle="Your current and recent login sessions"
        />
      ...
      <div className={sectionCls}>
        <SectionHead
          ...
          color="text-violet-400"
          title="API Access"
          subtitle="Use your tenant ID to authenticate API requests"
        />
        <div className="space-y-3">
          <div>
            ...
            <div className="flex items-center gap-2 bg-graphite-700/60 border border-surface-border rounded-xl px-4 py-2.5">
              <span className="flex-1 text-sm text-white/50 font-mono text-xs">
                Your tenant ID is shown in the URL and API responses
              </span>
            </div>
          </div>
          <div className="rounded-xl bg-blue-500/8 border border-blue-500/20 p-4">
            <p className="text-xs text-blue-300 font-semibold mb-2 flex items-center gap-2">
              <Info className="h-3.5 w-3.5" /> API Authentication
            </p>
            <p className="text-xs text-white/50">
    ...
    <div className="space-y-6">
      <div className="rounded-2xl border border-red-500/20 bg-red-500/5 p-6 space-y-4">
        <SectionHead
          ...
          color="text-red-400"
          title="Export Data"
          subtitle="Download a complete export of all your CRM data before making destructive changes"
        />
        <p className="text-xs text-white/40">
          Exports include all customers, leads, contacts, orders, appointments, and settings as a
          ZIP archive.
        </p>
      ...
      <div className="rounded-2xl border border-red-500/20 bg-red-500/5 p-6 space-y-4">
        <SectionHead
          ...
          title="Reset Website"
          subtitle="Clear all website pages, sections, and settings and start from scratch"
        />
        <p className="text-xs text-white/40">
          This is irreversible. All published pages and sections will be deleted.
        </p>
      ...
      <div className="rounded-2xl border-2 border-red-500/30 bg-red-500/5 p-6 space-y-4">
        <SectionHead
          ...
          subtitle="Permanently delete this workspace and all associated data"
        />
