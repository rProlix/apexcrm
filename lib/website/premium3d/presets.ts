...
export const INDUSTRY_PRESETS: IndustryPreset[] = [
  ...
  {
    key: 'vehicle_showroom',
    label: 'Car Rental Vehicle Showcase',
    industry: 'automotive',
    description: 'A vehicle orbits like a premium showroom turntable.',
    renderMode: 'three_model',
    animationPreset: 'showroomOrbit',
    lightingPreset: 'showroom',
    ...
    content: {
      initialRotation: { x: 0, y: -0.6, z: 0 },
      targetRotation: { x: 0, y: 2.4, z: 0 },
      cameraZoom: 1.1,
      cameraPath: 'arc',
    },
  ...
  {
    key: 'luxury_abstract',
    label: 'Law Firm Premium Abstract',
    industry: 'legal',
    description: 'A refined abstract premium scene for professional services.',
    renderMode: 'three_model',
    animationPreset: 'premiumAbstract',
    lightingPreset: 'luxuryGlow',
    ...
    assetNeeded:
      'Optional GLB (scales of justice, city, documents) — works as a premium abstract scene without one.',
  },
  {
    key: 'trades_tool_orbit',
    label: 'Plumbing / Trades Tool Orbit',
    industry: 'trades',
    description: 'Tools, pipes and water flow orbit through the service steps.',
    renderMode: 'three_model',
    animationPreset: 'toolOrbit',
    lightingPreset: 'outdoorConstruction',
  ...
  {
    key: 'mascot_intro',
    label: 'Character / Mascot Intro',
    industry: 'entertainment',
    description: 'A brand character or mascot animates in on scroll.',
    renderMode: 'three_model',
    animationPreset: 'characterIntro',
    lightingPreset: 'premiumSpotlight',
    environmentPreset: 'studio',
    textAnimation: 'scaleWords',
    palette: {
      background: '#0d0a16',
  ...
  {
    key: 'luxury_service_reveal',
    label: 'Luxury Service Reveal',
    industry: 'services',
