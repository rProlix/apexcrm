        ...
        <>
          ...
          <button
            ...
            className={cn(
              ...
              'opacity-100 shadow-panel focus-ring'
            )}
          ...
          <div className="pointer-events-none absolute inset-0 rounded-2xl border border-dashed border-brand/25 ring-1 ring-brand/[0.04]" />
        </>
      )}
      {children}
    </div>
